...
public class ReportController {
    ...
    public Result getBusinessReportData(){
        //模拟数据进行开发
       /* Map<String,Object> data=new HashMap<>();
        data.put("reportDate","2019.11.21");
        data.put("todayNewMember",10);
        data.put("totalMember",500);
        data.put("thisWeekNewMember",100);
        data.put("thisMonthNewMember",300);
        data.put("todayOrderNumber",10);
        data.put("todayVisitsNumber",20);
        data.put("thisWeekOrderNumber",20);
        data.put("thisWeekVisitsNumber",30);
        data.put("thisMonthOrderNumber",100);
        data.put("thisMonthVisitsNumber",80);
        List<Map<String,Object>>hotSetmeal=new ArrayList<>();
        Map<String,Object>map=new HashMap<>();
        map.put("name","体检套餐1");
        map.put("setmeal_count",5);
        map.put("proportion",0.5);
        Map<String,Object>map1=new HashMap<>();
        map1.put("name","体检套餐1");
        map1.put("setmeal_count",15);
        map1.put("proportion",0.2);
        hotSetmeal.add(map);
        hotSetmeal.add(map1);
